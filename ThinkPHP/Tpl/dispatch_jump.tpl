...
<head>
    ...
    <style type="text/css">
        *{ padding: 0; margin: 0; }
        ...
        .system-message .success,.system-message .error{ line-height: 1.5em; font-size: 28px; }
...
<body   style="margin:auto;width:20%;margin-top:20%;border:0px solid red;background:#F9F9F9">
	...
	<?php if(isset($message)) {?>
      <!-- 成功提示 -->
		<div class="sweet-alert showSweetAlert visible" data-custom-class="" data-has-cancel-button="false" data-has-confirm-button="true" data-allow-outside-click="false" data-has-done-function="false" data-animation="pop" data-timer="null" style="display: block; margin-top: -176px;"><div class="sa-icon sa-error" style="display: none;">
            ...
            </div><div class="sa-icon sa-custom" style="display: none; width: 80px; height: 80px; background-image: url(http://www.jq22.com/demo/jquery-SweetAlert20151027/images/thumbs-up.jpg);"></div><h2><?php echo($message); ?></h2>
            <p style="display: block;" class="success"></p>正在跳转，等待时间： <b id="wait"><?php echo($waitSecond); ?></b>
            <fieldset>
...
<!-- 失败提示 -->
	<div class="sweet-alert showSweetAlert visible" data-custom-class="" data-has-cancel-button="false" data-has-confirm-button="true" data-allow-outside-click="false" data-has-done-function="false" data-animation="pop" data-timer="null" style="display: block; margin-top: -176px;"><div class="sa-icon sa-error animateErrorIcon" style="display: block;">
          ...
          <div class="sa-placeholder"></div>
          <div class="sa-fix"></div>
        </div><div class="sa-icon sa-custom" style="display: none;"></div><h2><?php echo($error); ?></h2>
        <p style="display: block;" class="error"></p>正在跳转，等待时间： <b id="wait"><?php echo($waitSecond); ?></b>
        <fieldset>
          <input type="text" tabindex="3" placeholder="">
          <div class="sa-input-error"></div>
        </fieldset><div class="sa-error-container">
